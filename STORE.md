# AI Products Store - Automated Income System
...
### 1. ChatGPT Prompts Bundle
- 130+ Business & Life Prompts
- Marketing, Sales, Content Creation
- Price: ₩5,000 (~$4)

### 2. Midjourney V6 Complete Guide  
- 250+ Image Generation Prompts
- Photography, Fashion, Architecture
- Price: ₩5,000 (~$4)
...
### 4. Notion Templates
- Life OS, Business, Creative Templates
- Price: ₩3,000 (~$2)
...
- Send proof to: (your email)

---

## 🤖 Automated System

This store is designed to run with minimal maintenance:
- Products auto-delivered via link
